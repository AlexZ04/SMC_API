...
public class GetFeatureTogglesMessageAdminProcessor implements MessageAdminProcessor {
    ...
    public UserResponseItem processMessage(MessageRequestBody request, BotUser user) {
        return responseService.createUserResponse(user, user.getCurrentState(), featureToggleService.getSystemTogglesInfo());
    }

    @Override
    public MessageMeaningType meaning() {
        return MessageMeaningType.GET_FEATURE_TOGGLES;
    }
}
