...
public class ScheduleDistributionSendService implements DistributionSendService {
    ...
    public List<PlatformReceiver> getReceivers(BotUser user) {
        return userService.findBotUsersByGroup(DistributionGroups.SCHEDULE_SUBSCRIBERS);
    }
}
